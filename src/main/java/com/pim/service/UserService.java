...
public class UserService {
    ...
    public ResponseDTO create(UserCreateDTO input, com.pim.model.dummy.User requester) {
        User user = new User();
    ...
    public ResponseDTO delete(long id, com.pim.model.dummy.User requester)
    {
    ...
    public ResponseDTO changePassword(ChangePasswordDTO input, com.pim.model.dummy.User requester) {
    ...
    public ResponseDTO login(LogInDTO input, com.pim.model.dummy.User requester) {
        User user = userRepository.findByUsernameAndStatus(input.getUsername(), "V");
        if (user == null) {
            return output.generateErrorResponse("User Not Found!");
        } else {
